...
export function updateRejectedSuggestedLabelList(
  labelList: string[]
): AIActionTypes {
  return {
...
export function updateSSDObjectDetectorStatus(
...
export function updateYOLOV5ObjectDetectorStatus(
...
export function updatePoseDetectorStatus(
...
export function updateRoboflowAPIDetails(
