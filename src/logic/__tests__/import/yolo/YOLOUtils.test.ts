...
import {
  AnnotationsParsingError,
  LabelNamesNotUniqueError,
} from "../../../import/yolo/YOLOErrors";
...
describe("YOLOUtils parseYOLOAnnotationFromString method", () => {
  ...
  it("should throw AnnotationsParsingError", () => {
    ...
    // when
    function wrapper() {
      return YOLOUtils.parseYOLOAnnotationFromString(
        rawAnnotation,
        labelNames,
        imageSize,
        imageName
...
describe("YOLOUtils parseYOLOAnnotationsFromString method", () => {
  ...
  it("should throw AnnotationsParsingError", () => {
    ...
    // when
    function wrapper() {
      return YOLOUtils.parseYOLOAnnotationsFromString(
        rawAnnotations,
        labelNames,
        imageSize,
        imageName
