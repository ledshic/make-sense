...
export class AISSDObjectDetectionActions {
  public static detectRectsForActiveImage(): void {
    ...
    AISSDObjectDetectionActions.detectRects(
      activeImageData.id,
  ...
  public static detectRects(imageId: string, image: HTMLImageElement): void {
    ...
    SSDObjectDetector.predict(image, (predictions: DetectedObject[]) => {
      const suggestedLabelNames =
        AISSDObjectDetectionActions.extractNewSuggestedLabelNames(
  ...
  public static saveRectPredictions(
    ...
    const predictedLabels: LabelRect[] =
      AISSDObjectDetectionActions.mapPredictionsToRectLabels(predictions);
