...
export class AIYOLOObjectDetectionActions {
  public static detectRectsForActiveImage(): void {
    ...
    AIYOLOObjectDetectionActions.detectRects(
      activeImageData.id,
  ...
  public static detectRects(imageId: string, image: HTMLImageElement): void {
    ...
    YOLOV5ObjectDetector.predict(image, (predictions: DetectedObject[]) => {
      const suggestedLabelNames =
        AIYOLOObjectDetectionActions.extractNewSuggestedLabelNames(
  ...
  public static saveRectPredictions(
    ...
    const predictedLabels: LabelRect[] =
      AIYOLOObjectDetectionActions.mapPredictionsToRectLabels(predictions);
